...
You'll also need to clone the scala repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/scala-project/scala.git
cd scala/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/scala-project/gitian.sigs/) repo on your GitHub account.
