...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Scala code or Scala's dependency code or Scala's potential/future dependency code or research which successfully implements Scala.
