...
The intended audience are developers, who want to leverage newly added tricks to Scala via `CMake`. The document will lower the entry point for these developers.
